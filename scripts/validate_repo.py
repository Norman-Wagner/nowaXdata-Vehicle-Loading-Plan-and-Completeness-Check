...
def main() -> int:
    errors: list[str] = []
    required = ["README.md", "CHANGELOG.md", "CONTRIBUTING.md", "SECURITY.md", "LICENSE.txt", "NOTICE.txt", ".codex-plugin/plugin.json", ".github/dependabot.yml", ".github/workflows/validate.yml", ".github/workflows/release.yml", "tests/cases.json"]
    for rel in required:
    ...
    refs = {"methodology.md", "load-plan-model.md", "inspections-and-defects.md", "safety-and-compliance.md", "privacy.md", "industry-examples.md"}
